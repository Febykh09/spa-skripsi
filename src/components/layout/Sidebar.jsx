            ...
            <ul className="flex flex-col gap-y-8">
              ...
              {role === "admin" &&  <li className="flex flex-row gap-x-2 items-center text-[#282828] hover:text-[#2C71E1] group">
                {/* icon black */}
                  ...
                  <g clip-path="url(#clip0_527_4762)">
                  <path d="M19.2592 17.0155C19.4253 17.4384 19.4253 17.8613 19.1762 18.1996C18.9271 18.5378 18.5949 18.7916 18.0967 18.7916H1.90334C1.48813 18.7916 1.07292 18.5378 0.823789 18.1996C0.574662 17.8613 0.574669 17.3538 0.740754 17.0155L2.48464 13.125H17.4323L19.2592 17.0155Z" stroke="#282828" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M17.4352 13.1257V2.45898C17.4352 1.79232 16.8539 1.20898 16.1896 1.20898H3.73295C3.0686 1.20898 2.4873 1.79232 2.4873 2.45898V13.1257H17.4352Z" stroke="#282828" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M8.75 16.291H11.25" stroke="#282828" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M10 8.79094C11.3807 8.79094 12.5 7.67173 12.5 6.29102C12.5 4.91031 11.3807 3.79102 10 3.79102C8.61933 3.79102 7.5 4.91031 7.5 6.29102C7.5 7.67173 8.61933 8.79094 10 8.79094Z" stroke="#282828" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M13 10.6257C12.25 9.79232 11.1667 9.20898 10 9.20898C8.83333 9.20898 7.75 9.70898 7 10.6257" stroke="#282828" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                  </g>
                  <defs>
                  <clipPath id="clip0_527_4762">
                  <rect width="20" height="20" fill="white"/>
                  </clipPath>
                  </defs>
                  </svg>
                ...
                <g clip-path="url(#clip0_527_4768)">
                <path d="M19.2593 17.0155C19.4253 17.4384 19.4253 17.8613 19.1762 18.1996C18.9271 18.5378 18.5949 18.7916 18.0967 18.7916H1.90334C1.48813 18.7916 1.07292 18.5378 0.823789 18.1996C0.574662 17.8613 0.574669 17.3538 0.740754 17.0155L2.48464 13.125H17.4323L19.2593 17.0155Z" stroke="#2C71E1" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M17.4352 13.1257V2.45898C17.4352 1.79232 16.8539 1.20898 16.1896 1.20898H3.73295C3.0686 1.20898 2.4873 1.79232 2.4873 2.45898V13.1257H17.4352Z" stroke="#2C71E1" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M8.75 16.291H11.25" stroke="#2C71E1" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M10 8.79094C11.3807 8.79094 12.5 7.67173 12.5 6.29102C12.5 4.91031 11.3807 3.79102 10 3.79102C8.61933 3.79102 7.5 4.91031 7.5 6.29102C7.5 7.67173 8.61933 8.79094 10 8.79094Z" stroke="#2C71E1" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M13 10.6257C12.25 9.79232 11.1667 9.20898 10 9.20898C8.83333 9.20898 7.75 9.70898 7 10.6257" stroke="#2C71E1" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
                <clipPath id="clip0_527_4768">
                <rect width="20" height="20" fill="white"/>
                </clipPath>
                </defs>
                </svg>
