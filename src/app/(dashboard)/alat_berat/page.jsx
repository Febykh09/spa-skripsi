  ...
  return (
    <main className="w-full md:w-5/6 bg-[#FDFDFD] container mx-auto pl-16 pr-12 pt-12 min-h-screen">
      ...
      <section className="flex justify-between items-center mt-14">
        <h3 className="text-2xl font-semibold leading-snug text-[#202020]">
          Alat Berat
        </h3>
        {role === "user" && (
          <Button>
      ...
      <TableAlatBerat
        allPerusahaan={allPerusahaanData ? allPerusahaanData : []}
        allAlatBeratData={allAlatBeratData ? allAlatBeratData : []}
      />
    </main>
  );
}
